...
'''
Você deve criar uma classe carror que vai possui dois atributos compostos por outras duas classes:
...
A direção terá a responsabilidade de controlar a direção.Ela oferece os seguitnes atributos:
